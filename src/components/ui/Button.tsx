...
const button = cva(["transition-colors", "focus:outline-none", "focus:ring-2", "focus:ring-offset-2", "border", "inline-flex", "items-center"], {
  variants: {
    intent: {
      primary: ["bg-primary-600", "text-white", "hover:bg-primary-700", "focus:ring-primary-500", "border-transparent"],
      white: ["bg-white", "text-primary", "hover:bg-gray-200", "focus:ring-primary", "border-transparent"],
...
export default function Button({ intent, size, fullWidth, withIcon, children, ...props }: Props) {
  return (
